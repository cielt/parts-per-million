					...
					<div class="page-content">
						<div class="pt-6 pb-6 px-4">
							<div class="w-max max-640">
								...
								<p>The clock&rsquo;s purpose is to inform citizens of how much time the world has to reach zero emissions before the effects of climate change are permanently solidified. Additionally, the clock tells how much time the world has until total warming of 1.5 degrees centigrade, a milestone that if reached would encourage the global community to set a new warming limit. Setting a new warming ceiling can have catastrophic effects including increased food and water shortages as well as more frequent natural disaster events. There are three clocks worldwide, one in Seoul, one in Glasgow, and one in NYC. In addition to a simple countdown, the clock displays three additional messages including &ldquo;solutions exist&rdquo;, &ldquo;delay=denial,&rdquo; as well as the signature hashtag &ldquo;Let&rsquo;s #ActInTime.&rdquo;</p>
							</div>
						</div>
					</div>
				</div>
