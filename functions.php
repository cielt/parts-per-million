...
if ( ! function_exists( 'parts_per_million_setup' ) ) :
	...
	function parts_per_million_setup() {
		 ...
		 */
		load_theme_textdomain( 'parts-per-million', get_template_directory() . '/languages' );
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'parts_per_million_custom_background_args',
				array(
...
function parts_per_million_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'parts_per_million_content_width', 640 );
}
